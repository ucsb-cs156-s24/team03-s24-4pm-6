...
describe("HelpRequestEditPage tests", () => {
    ...
    describe("when the backend doesn't return data", () => {
        ...
        beforeEach(() => {
            ...
            axiosMock.onGet("/api/help", { params: { id: 17 } }).timeout();
        });
    ...
    describe("tests where backend is working normally", () => {
        ...
        beforeEach(() => {
            ...
            axiosMock.onGet("/api/currentUser").reply(200, apiCurrentUserFixtures.userOnly);
            axiosMock.onGet("/api/systemInfo").reply(200, systemInfoFixtures.showingNeither);
            axiosMock.onGet("/api/help", { params: { id: 17 } }).reply(200, {
                id: 17,
            ...
            axiosMock.onPut('/api/help').reply(200, {
                id: "17",
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(requesterEmailField).toHaveValue("ibareket@ucsb.edu");
            expect(teamIdField).toHaveValue("6");
            expect(tableOrBreakoutRoomField).toHaveValue("table");
            expect(requestTimeField).toHaveValue("2023-01-02T12:00");
        ...
        test("Changes when you click Update", async () => {
            ...
            expect(mockToast).toBeCalledWith("HelpRequest Updated - id: 17 requesterEmail: test@ucsb.edu");
